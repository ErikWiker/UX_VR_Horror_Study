...
public class OptitrackStreamingClient : MonoBehaviour
{
	...
	public void Initialize(string _LocalAddress, string _ServerAddress, int _ServerCommandPort, int _ServerDataPort){
        ...
        Debug.Log("OptitrackSC Initialize");
		StartOptitrackStreamingClient ();
	}
    ...
    /// </summary>
    void StartOptitrackStreamingClient()
    {
        Debug.Log("OptitrackSC StartOptitrackStreamingClient");
        ...
        try
        {
            Debug.Log("OptitrackSC trying to instantiate NatNextClient");
            m_client = new NatNetClient( connType );
            Debug.Log("OptitrackSC attempting to call Connect");
